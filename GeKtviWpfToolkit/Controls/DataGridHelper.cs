...
namespace GeKtviWpfToolkit.Controls
{
    public static class DataGridHelper
    {
        ...
        public static readonly DependencyProperty IsAnimationEnabledProperty =
            DependencyProperty.RegisterAttached(
                nameof(IsAnimationEnabledProperty),
                typeof(bool),
                typeof(DataGridHelper));

        public static bool GetIsAnimationEnabled(DataGrid dataGrid)
        {
            return (bool)dataGrid.GetValue(IsAnimationEnabledProperty);
        }

        public static void SetIsAnimationEnabled(DataGrid dataGrid, bool value)
        {
            dataGrid.SetValue(IsAnimationEnabledProperty, value);
        }

        //public static readonly DependencyProperty AnimationDyrationProperty =
        //    DependencyProperty.RegisterAttached(
        //        nameof(IsAnimationEnabledProperty),
        //        typeof(bool),
        //        typeof(DataGridHelper));
